...
const Preloader = ({ onComplete }: PreloaderProps) => {
    ...
    useEffect(() => {
        ...
        const prepDraw = (el: SVGGeometryElement) => {
            try {
                const length = Math.ceil(el.getTotalLength?.() ?? 0);
                if (length > 0) {
        ...
        const rootPaths = Array.from(
            svgRef.current.querySelectorAll<SVGPathElement>("#roots-group .draw-path")
        );
        const branchPaths = Array.from(
            svgRef.current.querySelectorAll<SVGPathElement>("#branches-group .draw-path")
        );
        ...
        const foliageClusters = Array.from(
            svgRef.current.querySelectorAll<SVGGElement>("#foliage-group .foliage")
        );
        ...
        >
            <div className="flex flex-col items-center gap-5">
                ...
                >
                    ...
                    <g id="trunk">
                        <path
                            d="M110 164 L112 118 C112 110 120 106 120 106 C120 106 128 110 128 118 L130 164 Z"
                            fill="#5D4037"
                        />
                    </g>
                    ...
                    <g id="foliage-group" filter="url(#canopyShadow)">
                        <g className="foliage">
                            <ellipse cx="120" cy="88" rx="42" ry="26" fill="#2E7D32" opacity="0.95" />
                        </g>
                        <g className="foliage">
                    ...
                    <g id="sun-group">
                        <g id="sun" transform="translate(162,98)">
                            <circle cx="0" cy="0" r="13" fill="url(#sunGrad)" opacity="0.95" />
                        </g>
                        <g id="rays" transform="translate(162,98)" opacity="0.85">
                            <line x1="0" y1="-20" x2="0" y2="-14" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="0" y1="14" x2="0" y2="20" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="-20" y1="0" x2="-14" y2="0" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="14" y1="0" x2="20" y2="0" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="-15" y1="-15" x2="-10" y2="-10" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="10" y1="10" x2="15" y2="15" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="-15" y1="15" x2="-10" y2="10" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                            <line x1="10" y1="-10" x2="15" y2="-15" stroke="#F39C12" strokeWidth="2" strokeLinecap="round" />
                        </g>
                    </g>
                ...
                <div className="text-center">
                    ...
                    <div className="mt-2 w-36 h-1 bg-[#2E5339]/20 rounded-full overflow-hidden">
                        <div
